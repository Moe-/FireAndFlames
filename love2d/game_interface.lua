...
function GameInterface:__init(waterFillStatusFunction, fireFillStatusFunction, gameStatusFunction)
  ...
  self.waterFillStatusFunction = waterFillStatusFunction or function () return 100 end --TODO put function to get water status here
  self.fireFillStatusFunction = fireFillStatusFunction or function () return 75 end --TODO see above
...
function GameInterface:drawPlayerBars()
  ...
  love.graphics.draw(self.waterFGImage, self.barHorizontalScreenOffset+self.fgBorderXOffset, self.barVerticalScreenOffset+self.fgBorderYOffset, 0, self.waterFillStatusFunction()/10, 1)
  --fire
  ...
  love.graphics.draw(self.fireFGImage, love.graphics.getWidth()-self.barHorizontalScreenOffset-self.fgBorderXOffset, self.barVerticalScreenOffset+self.fgBorderYOffset, 0, -1.0*self.fireFillStatusFunction()/10, 1)
end
